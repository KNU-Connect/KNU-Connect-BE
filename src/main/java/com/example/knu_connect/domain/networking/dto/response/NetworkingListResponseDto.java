...
@Schema(description = "네트워킹 목록 조회 응답")
public record NetworkingListResponseDto(
        @Schema(description = "게시물 목록")
        List<NetworkingBoardDto> boards,
    ...
    @Schema(description = "네트워킹 게시물 정보")
    public record NetworkingBoardDto(
